...
- 2026-08-09、catalog先頭の「01」カードで欠落していたR09 gameplay thumbnailを720×405 JPEGとして追加し、全release IDに対応する1 KB超の画像が存在することを回帰testへ固定した。strict TypeScript、Vitest 46 files／239 tests、production buildが合格し、commit `d261b26`のGitHub Pages run（ID `31270965166`）はbuild／deployとも成功した。公開`catalog/r09.jpg`はHTTPS 200、local assetと同じSHA-256 `4c6e9cca76e230182084eaa8bd4be5266da10a32339e309dd3acaf59d5a86f92`で、実browser上もnatural size 720×405、opacity 1、HTTP failure 0だった。公開入口、R01／R06／R08／R09、Forge F-01もHTTPS 200を維持した。
