...
const CACHE_VERSION = "snapshot-79bf341-v1";
  ...
  event.waitUntil(
    (async () => {
      ...
      if (!isCacheable(indexResponse)) {
        throw new Error("The R03 application shell could not be cached.");
      }
...
async function networkFirstNavigation(request) {
  try {
    ...
    return new Response(
      "<!doctype html><html lang=\"ja\"><meta charset=\"utf-8\"><meta name=\"viewport\" content=\"width=device-width\"><title>オフライン</title><body style=\"margin:2rem;background:#07110f;color:#fff3c4;font-family:system-ui\"><h1>オフラインです</h1><p>一度オンラインでR03を起動すると、この試作を端末に保存できます。</p></body></html>",
      {
        status: 503,
...
async function cacheIndexAndLinkedAssets(cache, response) {
  ...
  if (!contentType.includes("text/html")) {
    throw new Error("The R03 application shell index is not HTML.");
  }
