  ...
  event.waitUntil(
    (async () => {
      ...
      if (!isCacheable(indexResponse)) {
        throw new Error("The application shell index could not be cached.");
      }
...
async function networkFirstNavigation(request) {
  try {
    ...
    return new Response(
      "<!doctype html><html lang=\"ja\"><meta charset=\"utf-8\"><meta name=\"viewport\" content=\"width=device-width\"><title>オフライン</title><body style=\"margin:2rem;background:#07110f;color:#fff3c4;font-family:system-ui\"><h1>オフラインです</h1><p>一度オンラインで起動すると、この世界を端末に保存できます。</p></body></html>",
      {
        status: 503,
